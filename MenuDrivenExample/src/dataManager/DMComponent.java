...
public class DMComponent {
	...
	public void removeList(String name){
        int i = getIndexForList(name);
	    if(lol.isEmpty()){IOComponent.getComponent().output("The are no list yet in the system.");}
	    else if (i == - 1)IOComponent.getComponent().output("No such list in the system");
	    else{
	        lol.remove(i);
        }
    }
