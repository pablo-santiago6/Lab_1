...
public class LinkedPositionalListTester1 {
	...
	public static void main(String[] args) {
		...
		Position<Integer> f2 = list3.addFirst(13);
		Position<Integer> l2 = list3.addLast(53);
		Position<Integer> t = list3.addAfter(f2, 0);
		Position<Integer> s = list3.addBefore(l2, 1);

		showList3("testing ", list3);
	}
	...
	private static void showList3(String msg, LinkedPositionalList<Integer> list) {
		System.out.print(msg);
		PositionalListElementsBackwardIterator<Integer> iter = new PositionalListElementsBackwardIterator<>(list);
